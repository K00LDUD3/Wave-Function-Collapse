...
class MeshInfo:
    #getting mesh sauce
    mesh_data = {}
    with open("/Users/tanushsrivatsa/Work/Wave-Function-Collapse/MeshData.bin", "rb") as f:
...
def FetchMesh(name: str, path = "/Users/tanushsrivatsa/Work/Wave-Function-Collapse/Models/") -> bpy.types.Object:
